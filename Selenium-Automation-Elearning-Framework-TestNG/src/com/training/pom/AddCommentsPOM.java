...
public class AddCommentsPOM {
	private WebDriver driver; 
	
	public AddCommentsPOM(WebDriver driver) {
		this.driver = driver; 
	...
	@FindBy(xpath = "//*[@class='container']/ul/li[5]/a")
	private WebElement bloglink;
	
	@FindBy(xpath = "//*[@class='col-md-8']/div/div/h3/a")
	private WebElement addedpost;
	
	@FindBy(xpath = "//*[@class='col-md-8']/div/div/a")
	...
	@FindBy(xpath="//*[@class='wp-menu-image dashicons-before dashicons-admin-comments']")
	private WebElement comments;
	
	@FindBy(xpath="//*[@id='the-comment-list']/tr/td[2]/p")
	private WebElement addedcomment;
	
	@FindBy(xpath="//*[@id='the-comment-list']/tr/td[3]/div/a")
	private WebElement addedPost;
	...
	public void VerifyAddedPost(String PostName){
		String actualpostname = addedpost.getText();
		String expectedpostname = PostName;
		Assert.assertEquals(actualpostname, expectedpostname);
	}
	...
	public void VerifyAddedComment(String comment){
		String actualcomment = addedcomment.getText();
		String expectedcomment = comment;
		Assert.assertEquals(actualcomment, expectedcomment);
	}
	
	public void VerifyCommentedPost(String PostName){
		String actualpostname = addedPost.getText();
		String expectedpostname = PostName;
		Assert.assertEquals(actualpostname, expectedpostname);
	}
